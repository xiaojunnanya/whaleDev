...
export class ResultUtil {
    ...
    public static errorByErrorCode(errorCode: ErrorCode): BaseResponse<null> {
        return new BaseResponse<null>(errorCode.code, errorCode.message, null, 'error');
    }
     ...
     * @return
     */
    public static errorByCodeAndMessage(code: number, message: string): BaseResponse<null> {
     ...
     * @return
     */
    public static errorByErrorCodeAndMessage(errorCode: ErrorCode, message: string): BaseResponse<null> {
