...
export class ThrowUtil {
   ...
   */
    ...
    * @param message 错误信息
    */
    static throwByMessageIf(condition: boolean, errorCode: ErrorCode, message: string): void {
        ThrowUtil.throwByErrorIf(condition, new BusinessException(errorCode, message));
    }
}